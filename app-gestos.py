...
while(cap.isOpened()):
    ...
    if count_defects == 0:
        cv2.putText(img,"Muetras 1 dedo", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    elif count_defects == 1:
        str = "Muetras 2 dedo"
        cv2.putText(img, str, (5, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, 2)
    elif count_defects == 2:
        cv2.putText(img,"Muetras 3 dedo.", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    elif count_defects == 3:
        cv2.putText(img,"Muetras 4 dedo", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    else:
        cv2.putText(img,"Muetras 5 dedo", (50, 50),\
